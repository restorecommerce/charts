...
![Version: 0.1.61](https://img.shields.io/badge/Version-0.1.61-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.10.11](https://img.shields.io/badge/AppVersion-1.10.11-informational?style=flat-square)

Restorecommerce identity-srv

**Homepage:** <https://docs.restorecommerce.io/identity-srv/index.html>
...
| image.repository | string | `"ghcr.io/restorecommerce/identity-srv"` | Image to be used for deployment |
...
| seedAccounts | string | `""` | Provide the literal config through this string. Has to be in a JSON format - which is an array of User objects. Is run through `tpl` so you can use a helm template string |
| seedAccountsMountLocation | string | `"/seed-accounts.json"` | Location where to mount seed accounts json. |
| seedRoles | string | `""` | Provide the literal config through this string. Has to be in a JSON format - which is an array of Role objects. Is run through `tpl` so you can use a helm template string |
| seedRolesMountLocation | string | `"/seed-roles.json"` | Location where to mount seed roles json. |

...
Common labels
*/}}
{{- define "identity-srv.labels" -}}
helm.sh/chart: {{ include "identity-srv.chart" . }}
{{ include "identity-srv.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "identity-srv.selectorLabels" -}}
...
*/}}
{{- define "identity-srv.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "identity-srv.fullname" .) .Values.serviceAccount.name }}
{{- else }}

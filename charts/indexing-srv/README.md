...
![Version: 0.1.1](https://img.shields.io/badge/Version-0.1.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.0.15](https://img.shields.io/badge/AppVersion-0.0.15-informational?style=flat-square)

A Helm chart for restorecommerce indexing-srv

**Homepage:** <https://docs.restorecommerce.io/indexing-srv/index.html>
...
* <https://github.com/restorecommerce/indexing-srv>
...
| image.repository | string | `"ghcr.io/restorecommerce/indexing-srv"` | Image to be used for deployment |

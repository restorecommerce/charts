...
![Version: 0.1.1](https://img.shields.io/badge/Version-0.1.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.0.10](https://img.shields.io/badge/AppVersion-0.0.10-informational?style=flat-square)

A Helm chart for restorecommerce invoicing-srv

**Homepage:** <https://docs.restorecommerce.io/invoicing-srv/index.html>
...
| image.repository | string | `"ghcr.io/restorecommerce/invoicing-srv"` | Image to be used for deployment |
